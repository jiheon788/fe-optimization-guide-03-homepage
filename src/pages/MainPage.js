...
function MainPage(props) {
  const imagEl1 = useRef(null);
  const imagEl2 = useRef(null);
  const imagEl3 = useRef(null);
  ...
  useEffect(() => {
    ...
    observer.observe(imagEl1.current);
    observer.observe(imagEl2.current);
    observer.observe(imagEl3.current);
        ...
        <TwoColumns
          ...
          columns={[
            <Meta
              ...
              btnLink={"/part"}
            />,
            <img data-src={main_parts} ref={imagEl2} />,
          ]}
          mobileReverse={true}
        />
        <TwoColumns
          bgColor={"#f4f4f4"}
          columns={[
            <img data-src={main_styles} ref={imagEl3} />,
            <Meta
              title={"Riding Styles"}
              content={
